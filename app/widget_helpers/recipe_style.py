from app.config import (
    ...
    COLOR_RECIPE_DIVIDER, COLOR_RECIPE_TABLE_BG, COLOR_SCROLLBAR_HANDLE,
    COLOR_SCROLLBAR_HANDLE_HOVER, COLOR_TEXT_PRIMARY, COLOR_TEXT_SECONDARY,
    FONT_SIZE_RECIPE_BADGE, FONT_SIZE_RECIPE_INGREDIENT, FONT_SIZE_RECIPE_STEP_BODY,
    FONT_SIZE_RECIPE_STEP_NUMBER, FONT_SIZE_RECIPE_TITLE, OBJECT_NAME_RECIPE_AMOUNT,
    OBJECT_NAME_RECIPE_AMOUNT_TOP_UP, OBJECT_NAME_RECIPE_BADGE, OBJECT_NAME_RECIPE_DIVIDER,
    OBJECT_NAME_RECIPE_INGREDIENT_NAME, OBJECT_NAME_RECIPE_SCROLL, OBJECT_NAME_RECIPE_SECTION_LINE,
    OBJECT_NAME_RECIPE_STEP_BODY, OBJECT_NAME_RECIPE_STEP_NUMBER, OBJECT_NAME_RECIPE_TABLE,
    OBJECT_NAME_RECIPE_TITLE, RECIPE_CARD_BADGE_HEIGHT, RECIPE_CARD_BADGE_PADDING_H,
    RECIPE_CARD_PIP_SIZE, RECIPE_CARD_TABLE_RADIUS, SCROLLBAR_HANDLE_MIN_HEIGHT,
    SCROLLBAR_HANDLE_RADIUS, SCROLLBAR_WIDTH,
)
...
def build_recipe_stylesheet() -> str:
    ...
    QScrollArea#{OBJECT_NAME_RECIPE_SCROLL} QScrollBar:vertical {{
        background: transparent;
        width: {SCROLLBAR_WIDTH}px;
        margin: 0px;
        border: none;
    }}
    QScrollArea#{OBJECT_NAME_RECIPE_SCROLL} QScrollBar::handle:vertical {{
        background: {COLOR_SCROLLBAR_HANDLE};
        min-height: {SCROLLBAR_HANDLE_MIN_HEIGHT}px;
        border-radius: {SCROLLBAR_HANDLE_RADIUS}px;
    }}
    QScrollArea#{OBJECT_NAME_RECIPE_SCROLL} QScrollBar::handle:vertical:hover {{
        background: {COLOR_SCROLLBAR_HANDLE_HOVER};
    }}
    QScrollArea#{OBJECT_NAME_RECIPE_SCROLL} QScrollBar::add-line:vertical,
    QScrollArea#{OBJECT_NAME_RECIPE_SCROLL} QScrollBar::sub-line:vertical {{
        height: 0px;
        width: 0px;
        background: none;
        border: none;
    }}
    QScrollArea#{OBJECT_NAME_RECIPE_SCROLL} QScrollBar::add-page:vertical,
    QScrollArea#{OBJECT_NAME_RECIPE_SCROLL} QScrollBar::sub-page:vertical {{
        background: none;
    }}
    """
