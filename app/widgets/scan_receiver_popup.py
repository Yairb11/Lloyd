...
from app.config import (
    COLOR_VIDEO_BG, COLOR_VIDEO_TITLE, PHONE_SCAN_CANCELLED_MESSAGE,
    PHONE_SCAN_INSTRUCTIONS_FONT_SIZE, PHONE_SCAN_INSTRUCTIONS_TEXT, PHONE_SCAN_MAIN_MARGIN,
    PHONE_SCAN_MAIN_SPACING, PHONE_SCAN_PANEL_BG, PHONE_SCAN_PANEL_BORDER,
    PHONE_SCAN_PANEL_BORDER_RADIUS, PHONE_SCAN_PANEL_MARGIN, PHONE_SCAN_PORT,
    ...
    PHONE_SCAN_URL_FONT_SIZE, PHONE_SCAN_URL_TEXT_COLOR, PHONE_SCAN_WINDOW_HEIGHT,
    PHONE_SCAN_WINDOW_TITLE, PHONE_SCAN_WINDOW_WIDTH,
)
from app.network.phone_upload import (
    PhoneUploadHandler, PhoneUploadServer, ServerBridge,
    get_local_ip,
)
from app.threads.phone_server import PhoneServerWorker
