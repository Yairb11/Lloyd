...
from app.config import (
    ...
    CANVAS_POPUP_DEFAULT_TITLE,
    CANVAS_POPUP_DEFAULT_WIDTH,
    CANVAS_POPUP_EXPORTING_TEXT,
    CANVAS_POPUP_EXPORT_TEXT,
    CANVAS_POPUP_MIN_HEIGHT,
    CANVAS_POPUP_MIN_WIDTH,
    COLOR_CANVAS_POPUP_BORDER,
    OBJECT_NAME_CANVAS_POPUP,
)
