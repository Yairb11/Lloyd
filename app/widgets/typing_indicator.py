...
from app.config import (
    CHAT_BUBBLE_RADIUS, COLOR_BUBBLE_AGENT_BG, COLOR_BUBBLE_TEXT,
    COLOR_BUBBLE_USER_BG, COLOR_TEXT_SECONDARY, TYPING_BOUNCE_HEIGHT,
    TYPING_BUBBLE_HEIGHT, TYPING_BUBBLE_WIDTH, TYPING_CYCLE_SPEED,
    TYPING_DOT_COUNT, TYPING_DOT_PHASE_OFFSET, TYPING_DOT_RADIUS,
    TYPING_DOT_SPACING, TYPING_FRAME_INTERVAL_MS,
)


class _TypingBubble(QWidget):
...
class TypingIndicator(QWidget):
    def __init__(self, parent: QWidget | None = None, is_user: bool = False) -> None:
        super().__init__(parent)
        self._bubble = _TypingBubble(self, is_user=is_user)
