...
from app.config import (
    ...
    VOICE_LISTENING_AMPLITUDE_PEAK, VOICE_LOG_TRANSCRIPT_COMPARISON, VOICE_LOG_WAKE_MATCH,
    VOICE_MSG_MODEL_MISSING, VOICE_MSG_NO_COMMAND_HEARD, VOICE_MSG_VAD_UNAVAILABLE,
    VOICE_MSG_WAKE_GRAMMAR_UNSUPPORTED, VOICE_PAUSED_POLL_INTERVAL_MS, VOICE_PREROLL_S,
    VOICE_QUEUE_POLL_TIMEOUT_S, VOICE_SAMPLE_RATE_HZ, VOICE_STOP_KEYWORD,
    VOICE_STOP_KEYWORD_MATCH_THRESHOLD, VOICE_STOP_PHRASE, VOICE_STREAM_TRANSCRIPT_ENABLED,
    VOICE_VAD_ENABLED, VOICE_VOSK_WAKE_MODEL_DIR, VOICE_WAKE_GRAMMAR_ENABLED,
    VOICE_WAKE_GRAMMAR_UNKNOWN_TOKEN, VOICE_WAKE_GREETINGS, VOICE_WAKE_KEYWORD,
    VOICE_WAKE_KEYWORD_MAX_WORDS, VOICE_WAKE_KEYWORD_VARIANTS, VOICE_WAKE_REFRACTORY_S,
    VOICE_WHISPER_BEAM_SIZE, VOICE_WHISPER_BEST_OF, VOICE_WHISPER_COMPUTE_TYPE,
    VOICE_WHISPER_CONDITION_ON_PREVIOUS_TEXT, VOICE_WHISPER_CPU_THREADS, VOICE_WHISPER_DEVICE,
    VOICE_WHISPER_DOWNLOAD_ROOT, VOICE_WHISPER_LANGUAGE, VOICE_WHISPER_MODEL_SIZE,
    VOICE_WHISPER_TEMPERATURE, VOICE_WHISPER_VAD_FILTER, VOICE_WHISPER_WITHOUT_TIMESTAMPS,
)
...
class VoiceListener(QThread):
    ...
    listening_amplitude = pyqtSignal(float)
    ...
    def _capture_command(self) -> str:
        ...
        while True:
            ...
            self.listening_amplitude.emit(normalized_rms(chunk, VOICE_LISTENING_AMPLITUDE_PEAK))
        ...
        self.listening_amplitude.emit(0.0)
