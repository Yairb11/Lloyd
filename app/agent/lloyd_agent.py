...
from app.agent.recipe_card_schema import RECIPE_CARD_SCHEMA
...
from app.config import (
    ...
    AGENT_TOOL_ERROR_ANIMATION_SCHEMA,
    AGENT_TOOL_ERROR_SCAN,
    AGENT_TOOL_ERROR_SCAN_EMPTY,
    AGENT_TOOL_ERROR_WEB_SEARCH,
    AGENT_TOOL_RENDER_ANIMATION,
    AGENT_TOOL_RESULT_ANIMATION,
    AGENT_TOOL_RESULT_RECIPE,
...
def build_options(handlers: Any) -> ClaudeAgentOptions:
    system_prompt = (
        (_PROJECT_ROOT / AGENT_SYSTEM_PROMPT_PATH).read_text(encoding="utf-8").strip()
    )
