...
RESPONSE_SHAPE: str = (
    ...
    "character never buys you extra sentences. The only exceptions are formats "
    "explicitly marked as long-form, either under \"Answering without a tool\" or in "
    "a tool's description: they set their own length and paragraph structure, and "
    "they override the one-detail rule and the closing hand-back. Separate their "
    "paragraphs with a blank line. No markdown, no emoji, no JSON, no lists, no "
    "headings.\n"
    "\n"
