...
from app.config import (
    CATALOGUE_DIR,
    CATALOGUE_ENABLED,
    CATALOGUE_INTENT_PATTERN,
    CATALOGUE_MATCH_THRESHOLD,
    CATALOGUE_MAX_MESSAGE_WORDS,
    CATALOGUE_SKIP_PATTERN,
    CATALOGUE_SOURCES_FILE,
    LOG_PREFIX_ERROR,
)
...
def load() -> int:
    ...
    directory = _PROJECT_ROOT / CATALOGUE_DIR
    if directory.is_dir():
