...
from app.config import (
    ANIM_CONTAINER_LABEL_BUFF, ANIM_CONTAINER_LABEL_FONT_SIZE, ANIM_CONTAINER_MIXING_HEIGHT,
    ANIM_CONTAINER_MIXING_W_BOT, ANIM_CONTAINER_MIXING_W_TOP, ANIM_CONTAINER_OUTLINE_STROKE_WIDTH,
    ...
    ANIM_CONTAINER_STEM_BASE_HALF_WIDTH, ANIM_CONTAINER_STEM_LENGTH, ANIM_CONTAINER_TALL_HEIGHT,
    ANIM_CONTAINER_TALL_W_BOT, ANIM_CONTAINER_TALL_W_TOP, ANIM_LAYER_DEFAULT_OPACITY,
)
