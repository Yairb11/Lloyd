...
from app.config import (
    ...
    ANIM_GARNISH_FOAM_CORNER_RADIUS,
    ...
    ANIM_SPOON_INNER_X_SHIFT,
    ANIM_SPOON_KNOB_RADIUS,
    ANIM_SPOON_KNOB_STROKE_WIDTH,
    ...
    ANIM_STRAIN_POUR_CONTROL_1_OFFSET,
    ANIM_STRAIN_POUR_CONTROL_2_OFFSET,
    ANIM_STRAIN_POUR_START_OFFSET,
    ANIM_STRAIN_POUR_STROKE_WIDTH,
    ANIM_TOOL_Z_INDEX,
)
from app.helpers.cocktail_recipe import format_ingredient_label
